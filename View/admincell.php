...
while ($com = $users->fetch()){
    ...
    <em><a href="index.php?action=inspectUser&amp;id=<?= $com['id'] ?>">Supprimer cet utilisateur</a></em>
    <em><a href="index.php?action=editUserAdmin&amp;id=<?= $com['id'] ?>">Editer cet utilisateur</a></em>
    <?php } 
